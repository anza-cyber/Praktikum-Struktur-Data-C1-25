...
void jumpSearch(Kereta* arr, int n) {
    int target;
    cout << "\n--- Jump Search Berdasarkan Nomor Kereta ---\n";
    ...
    cout << "Data sudah diurutkan Berdasarkan nomor. Mulai jump search...\n";
...
int main() {
    ...
    do {
        ...
        cout << "5. Urutkan Berdasarkan Nama Kereta A-Z (Merge Sort)\n";
        cout << "6. Urutkan Berdasarkan Harga Termurah (Selection Sort)\n";
        cout << "0. Keluar\n";
        ...
        switch (pilihan) {
            ...
            case 3:
                ...
                break;
            case 4:
                jumpSearch(daftarKereta, jumlahKereta);
                break;
            case 5:
